...
$H_0: \mu = 60$   
$H_a: \mu \neq 60$ 
With $\alpha = 0.05$ and $P = 0.0932$, we are 95% confident that the observed mean does not equal to 60.
The second line of code evaluate the following hypothesis test:
$H_0: \mu = 60$   
$H_a: \mu < 60$ 
With $\alpha = 0.05$ and $P = 0.0466$, we are 95% confident that the observed mean is less than 60.
The first line of code evaluate the following hypothesis test:
$H_0: \mu = 60$   
$H_a: \mu \neq 60$ 
With $\alpha = 0.05$ and $P = 0.953$, we have a \code{p-value} larger than $\alpha = 0.05$,
